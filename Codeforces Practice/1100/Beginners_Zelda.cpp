...
// Choose two vertices of the tree u
//  and v
// ;
// Compress all the vertices on the path from u
//  to v
//  into one vertex. In other words, all the vertices on path from u
//  to v
//  will be erased from the tree, a new vertex w
//  will be created. Then every vertex s
//  that had an edge to some vertex on the path from u
//  to v
//  will have an edge to the vertex w
// .
// Illustration of a zelda-operation performed for vertices 1
//  and 5
// .
...
//  and vi
//  (1≤ui,vi≤n,ui≠vi
// ) — the numbers of vertices connected by the i
// -th edge.
...
// 2
// Note
// In the first test case, it's enough to perform one zelda-operation for vertices 2
//  and 4
// .
...
// u=2,v=1
// . Let the resulting added vertex be labeled as w=10
// ;
// u=4,v=9
// . Let the resulting added vertex be labeled as w=11
// ;
// u=8,v=10
